...
// Keep server test discovery, environment, and pool defaults unchanged. The
// only repo-wide settings are the per-file data-root setup and a timeout floor
// for hosts under load; individual tests may still use narrower timeouts.
