...
// "can be executed only from the game" pattern, which the 2026-08-23 B42
// audit had verbatim-confirmed just three days earlier.
//
...
// jar. This is the scope widening from the B42 audit's "Pass 4".
